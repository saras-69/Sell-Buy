...
@Component({
  ...
  templateUrl: './sigin-signup.component.html',
  styleUrl: './sigin-signup.component.css'
})
export class SiginSignupComponent {
  ...
  get rf() {
    ...
    onSubmitSignUp(){
      ...
      this.loginService.userRegister(this.user_dto).subscribe(data=>{
        ...
        this.router.navigateByUrl('http://localhost:4200/sign-in');
      })
    }
    onSubmitSignIn(){
